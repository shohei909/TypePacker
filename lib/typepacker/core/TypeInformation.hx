...
enum TypeInformation<T>
{
    ...
    CLASS(type:String, _class:Class<Dynamic>, fieldTypes:Map<String,String>, fieldNames:Array<String>, nameToAlias:Null<Map<String, String>>, serializeToArray:Bool, hasClone:Bool, hasIsSame:Bool);
